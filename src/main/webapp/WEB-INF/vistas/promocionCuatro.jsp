...
<body class="bg-dark">
    ...
    <main>
        <!--Descripcion de la promocion 4-->
        <section class="container-fluid row text-center contenedor-promo" style="margin-top: 3em;">
            <div class="container-fluid col">
                <img src="img/Promo4.jpeg" alt="Promocion 4" class="img-promo border" style="height: 25em;width: 20em">
            </div>
            <div class="container-fluid col text-center" style="margin-top: 6em; margin-right: 8em;">
                <h1 class="text-light">Promoción 4</h1>
                <p class="text-light">Comprando este combo te llevas 2 cervezas y Unos nachos con queso</p>
